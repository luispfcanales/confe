...
export const POSTULATION_CONFIG = {
    ...
    API: {
      ...
      ENDPOINTS: {
        SEARCH_BY_DNI: '/users/search-by-dni',
    ...
    LABELS: {
      ...
      PLACEHOLDERS: {
        ...
        ABSTRACT_TEXT: 'Ingrese el resumen de su investigación (máximo 250 palabras)',
        KEYWORDS: 'Ingrese palabras clave separadas por comas (máximo 5)',
    ...
    INSTRUCTIONS: {
      ...
      POSTER_INFO_STEP: [
        ...
        'El resumen debe incluir objetivo, metodología y resultados principales',
        'Las palabras clave deben ser relevantes al tema de investigación',
  ...
  export const STEP_LABELS = {
    [POSTULATION_CONFIG.STEPS.DOCUMENTS]: POSTULATION_CONFIG.LABELS.BUTTONS.DOWNLOAD.replace('Descargar', 'Documentos'),
