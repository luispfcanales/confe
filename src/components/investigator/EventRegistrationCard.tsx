...
export const EventRegistrationCard: React.FC<EventRegistrationCardProps> = ({ event }) => {
  ...
  const handleRegisterClick = () => {
    // Por ahora solo mostramos una alerta, luego navegará al formulario
    alert(`Próximamente: Formulario de registro para "${event.title}"`);
    // En el futuro: navigate('/investigator/events/register/' + event.id);
  };
